...
export default function SEOConfig({ title, description, pagePath = "" }: SEOConfigProps) {
  useEffect(() => {
    ...
    const structuredData = {
      ...
      "description": "LIONS KARATE CLUB PUNE delivers top-notch Karate Classes in Narhe Pune, Karate Classes Near Bhumkar Chowk, Karate Classes Near Silver Birch Hospital, and Self Defence Classes for kids, youth, and adults.",
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "VASUNDHARA PRE-PRIMARY SCHOOL, Narhe Ambegaon Road, Near Bhumkar Chowk, Beside Silver Birch Hospital, Narhe",
